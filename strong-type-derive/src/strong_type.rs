use crate::detail::{
    ...
    implement_basic, implement_basic_primitive, implement_basic_string, implement_bit_shift,
    implement_bool_ops, implement_display, implement_hash, implement_min_max, implement_nan,
    ,implement_bit_shift, implement_negate, UnderlyingTypeGroup,
};
